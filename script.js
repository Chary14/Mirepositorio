...
const productoA = new Producto("relojes mujer", 100, 20, 0.9)
const productoB = new Producto("relojes hombre", 80, 15, 0.95)
const productoC = new Producto("relojes kid", 50, 10, 0.95)
